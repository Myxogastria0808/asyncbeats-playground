...
const useWebSocket = (url: string): UseWebSocketHook => {
    ...
    return { audioInfoState, readyState, error, connect, disconnect };
};
...
const App: FC = () => {
    ...
    // useWebSocket hook
    const { audioInfoState, readyState, error, connect, disconnect } = useWebSocket(serverUrl);
        ...
        <main className="p-4 md:p-6 lg:p-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="items-center justify-between">
                ...
                <div className={`px-3 py-1 text-sm font-semibold rounded-full`}>
                    {audioInfoState
                        ? `Channel: ${audioInfoState.channel}, Sample Rate: ${audioInfoState.sampleRate}`
                        : 'No AudioInfo'}
                </div>
